...
describe.each(implementations)("%s adapter", (_, impl) => {
    ...
    describe("content", () => {
        ...
        describe("publish", () => {
            ...
            it("should fail if referencing unpublished content", async () => {
                ...
                await expect(content.setPublishedRev(pages, pageId, 1, models.content)).rejects.toBeInstanceOf(ReferenceConflictError);
            });
        ...
        describe("unpublish", () => {
            it("should fail if referenced by published content", async () => {
                ...
                await content.setPublishedRev(pages, pageId, 1, models.content);
                await expect(content.setPublishedRev(news, newsId, null, models.content)).rejects.toBeInstanceOf(ReferenceConflictError);
            });
        ...
        describe("delete", () => {
            it("should fail if referenced by published content", async () => {
                ...
                await content.setPublishedRev(pages, pageId, 1, models.content);
                await expect(content.delete(news, newsId)).rejects.toBeInstanceOf(ReferenceConflictError);
            });
        ...
        describe("constraints", () => {
            ...
            it("should not create content", async () => {
                await expect(content.create({ slug: "unique" }, { slug: "unique" }, uniqueContent, models.content, author)).rejects.toBeInstanceOf(UniqueFieldError);
            });
    ...
    describe("media", () => {
        ...
        it("should not delete media in use", async () => {
            ...
            await expect(media.delete(image1.id, models.content)).rejects.toBeInstanceOf(ReferenceConflictError);
            await content.setPublishedRev(news, id, 1, models.content);
            const data = {
                title: "News Rev 2",
                image: null
            ...
            await expect(media.delete(image3.id, models.content)).rejects.toBeInstanceOf(ReferenceConflictError);
        });
        ...
        it("should delete media when model doesn't exist anymore", async () => {
            ...
            await expect(media.delete(image.id, models.content)).rejects.toBeInstanceOf(ReferenceConflictError);
