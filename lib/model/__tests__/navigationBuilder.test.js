...
const navigationBuilder_1 = require("../navigationBuilder");
const filterModels_1 = require("../filterModels");
// const someModel = {
//   type: "content",
//   name: "foo",
//   plural: "Foos"
...
const filter = (0, filterModels_1.createModelFilter)(principal);
// const defaultGroup = {
//   type: "group",
//   name: "Content",
//   path: "content"
...
describe("navigationBuilder", () => {
    it("builds content navigation from models", () => {
        expect((0, navigationBuilder_1.buildInfo)([], Object.assign(Object.assign({}, models), { content: contentModels }), filter)).toEqual({
            modelPaths: {
                content: {
    ...
    it("does not include no-collection models in content", () => {
        expect((0, navigationBuilder_1.buildInfo)([], Object.assign(Object.assign({}, models), { content: [...contentModels, collectionNoneModel] }), filter)).toEqual({
            modelPaths: {
                content: {
                    contentPages: "/content/contentPages",
                    startPage: "/content/startPage"
    ...
    it("does not build content navigation when all models are referenced", () => {
        expect((0, navigationBuilder_1.buildInfo)([
            {
                name: "Pages",
                type: "group",
                path: "Page",
    ...
    it("fails when no-collection model is referred in navigation", () => {
        expect(() => {
            (0, navigationBuilder_1.buildInfo)([
                {
                    model: "product",
                    name: "Product",
                    path: "pageA",
