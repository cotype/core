...
function getRestApiBuilder(opts) {
...
function init(opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const persistence = yield (0, persistence_1.default)(models, yield opts.persistenceAdapter, {
        ...
        router.get("/admin/rest/info", (req, res) => __awaiter(this, void 0, void 0, function* () {
