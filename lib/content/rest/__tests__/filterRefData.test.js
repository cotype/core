...
describe("removeUnnecessaryRefData", () => {
    ...
    it("createJoin", () => __awaiter(void 0, void 0, void 0, function* () {
        const createdJoin = (0, filterRefData_1.createJoin)(join, models_1.default);
        yield expect(createdJoin).toStrictEqual({
            news: ["title", "slug"],
            articlenews: ["title", "slug"],
            products: ["ean"]
        });
    }));
    it("filteredContentData", () => __awaiter(void 0, void 0, void 0, function* () {
        const createdJoin = (0, filterRefData_1.createJoin)(join, models_1.default);
        const filteredContent = (0, filterRefData_1.filterContentData)(newsData, createdJoin);
        yield expect(filteredContent).toMatchObject({
    ...
    it("getContainingMedia", () => __awaiter(void 0, void 0, void 0, function* () {
        const mediaRefs = {
        ...
        yield expect(containingMedia).toStrictEqual({
            [newsData.data.image._id]: { someCrazyProps: "forBar" },
            [newsData.data.imageList[0]._id]: { someCrazyProps: "forBar2" }
        });
    }));
    it("removeUnnecessaryRefData", () => __awaiter(void 0, void 0, void 0, function* () {
        const meta = {
            size: 6548,
        ...
        const refs = {
            ...
            media: {
                [newsData.data.image._id]: Object.assign(Object.assign({}, meta), { id: newsData.data.image._id }),
                [faker_1.default.system.fileName()]: Object.assign(Object.assign({}, meta), { id: "image2.exe" })
            }
        };
        const cleanRefs = (0, filterRefData_1.default)([newsData, productData], refs, join, models_1.default);
        yield expect(cleanRefs).toStrictEqual({
            content: {
                news: {
                    "1": {
                        _id: "1",
...
describe("convertDeepJons", () => {
    it("get Join Levels", () => __awaiter(void 0, void 0, void 0, function* () {
        const deepJoins = (0, filterRefData_1.getDeepJoins)({
            news: ["title", "ref.ean"]
        }, models_1.default);
        yield expect(deepJoins).toStrictEqual([
            {
                news: ["title", "ref"]
            },
            {
    ...
    it("get Join Levels with List", () => __awaiter(void 0, void 0, void 0, function* () {
        const deepJoins = (0, filterRefData_1.getDeepJoins)({
    ...
    it("get Join Levels with List 2-Levels", () => __awaiter(void 0, void 0, void 0, function* () {
        const deepJoins = (0, filterRefData_1.getDeepJoins)({
