import removeUnnecessaryRefData, { createJoin, filterContentData, getContainingMedia, getDeepJoins } from "../filterRefData";
...
describe("removeUnnecessaryRefData", () => {
    ...
    it("createJoin", async () => {
        const createdJoin = createJoin(join, models);
    ...
    it("getContainingMedia", async () => {
        ...
        const containingMedia = getContainingMedia(newsData, models[0], mediaRefs);
    ...
    it("removeUnnecessaryRefData", async () => {
        ...
        const refs = {
            ...
            media: {
                ...
                [faker.system.fileName()]: Object.assign(Object.assign({}, meta), { id: "image2.exe" })
            }
        };
        const cleanRefs = removeUnnecessaryRefData([newsData, productData], refs, join, models);
