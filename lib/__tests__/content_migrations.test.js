...
describe("content migrations", () => {
    ...
    beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        ({ server } = yield (0, util_1.login)((0, supertest_1.default)(app), "admin@cotype.dev", "admin"));
    ...
    it("should have rewritten/added/removed data", () => __awaiter(void 0, void 0, void 0, function* () {
        const defaultData = { _id: "1", _refs: { content: {}, media: {} } };
        yield (0, wait_for_expect_1.default)(() => __awaiter(void 0, void 0, void 0, function* () {
            yield expect(yield find(exports.initialModel.name, "1", {}, false)).toStrictEqual(Object.assign(Object.assign({}, exports.draftsData), defaultData));
        }));
        yield (0, wait_for_expect_1.default)(() => __awaiter(void 0, void 0, void 0, function* () {
            expect(yield find(exports.initialModel.name, "1", {}, true)).toStrictEqual(Object.assign(Object.assign({}, exports.publishedData), defaultData));
        }));
    }));
});
