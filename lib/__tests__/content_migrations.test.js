...
describe("content migrations", () => {
    ...
    it("should have rewritten/added/removed data", async () => {
        ...
        await (0, wait_for_expect_1.default)(async () => {
            await expect(await find(exports.initialModel.name, "1", {}, false)).toStrictEqual({ ...exports.draftsData, ...defaultData });
        });
        await (0, wait_for_expect_1.default)(async () => {
            expect(await find(exports.initialModel.name, "1", {}, true)).toStrictEqual({
                ...exports.publishedData,
                ...defaultData
            });
        });
